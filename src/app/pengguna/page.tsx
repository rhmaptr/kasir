  ...
  return (
    ...
    <div className="bg-[#50C878] w-[110px] h-screen rounded-tr-[12px] rounded-br-[12px]">
      ...
      <div className="hover:bg-green-400 w-2 h-2 pl-[6px]">
        <p className="text-[14px] font-medium ml-[-3px]">Pengguna</p>
      </div>
      </div>
    ...
    <div className="bg-green-50 w-[1217px] h-[150px] mt-[65px] ml-[-1217px] rounded-[15px] shadow-lg">
      ...
      <p className="text-slate-400 text-[13px] font-medium ml-4">Klik 'tambah pengguna' jika ingin menambahkan pengguna</p>
      <Image
        src={"/laptop.svg"}
    ...
    <div className="bg-white w-[1217px] h-[390px] mt-[230px] ml-[-1217px] rounded-[15px] shadow-lg flex-col">
    <div className="bg-sky-400 w-[1179px] h-[50px] rounded-[15px] mt-2 ml-4 flex">
          <input className=" bg-white w-[1130px] h-[50px] rounded-tl-[13px] rounded-bl-[13px] shadow-lg text-black pl-4 font-medium" placeholder="Telusuri..."></input>
        ...
        <div className="bg-green-400 w-[210px] h-[40px] ml-4 mt-2 rounded-[10px] flex shadow-lg cursor-pointer">
          ...
          <div className="bg-pink-300 w-[165px] h-[30px] mt-[5px] pt-1 pl-1 font-medium">Tambah Pengguna</div>
        </div>
        <div className="bg-green-400 w-[1179px] h-[45px] mt-2 ml-4 rounded-[5px] shadow-lg flex">
          <p className="ml-[160px] mt-[10px] font-medium">Hak Akses</p>
          <p className="ml-[150px] mt-[10px] font-medium">Nama</p>
          <p className="ml-[165px] mt-[10px] font-medium">Kata Sandi</p>
          <p className="ml-[155px] mt-[10px] font-medium">No.HP</p>
          <p className="ml-[180px] mt-[10px] font-medium">Aksi</p>
        </div>
        <div className="bg-purple-400 w-[1179px] h-[222px] ml-4 mt-2 flex-col overflow-y-auto no-scrollbar">
          <div className="bg-orange-400 w-[1179px] h-[45px] rounded-[5px] pt-[5px] mt-2 flex shadow-md">
              <div className="bg-slate-400 w-[40px] h-[40px] ml-[25px] rounded-[20px] mt-[-3px]"></div>
            <div className="bg-yellow-300 w-[200px] h-[35px] ml-[30px]">
            ...
            <div className="bg-yellow-300 w-[200px] h-[35px] ml-[20px]">
              <div className="bg-rose-400 h-[23px] line-clamp-1 text-black font-medium mt-[6px] text-center">300.000</div>
            </div>
            <div className="bg-yellow-300 w-[200px] h-[35px] ml-[20px]">
